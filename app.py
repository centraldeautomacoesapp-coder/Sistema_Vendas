...
def carregar_dados_nuvem():
    # Cria a pasta destino usando o caminho absoluto do servidor da nuvem
    ...
    # Procura todos os arquivos .xlsx recursivamente dentro da pasta destino absoluta
    ...
    if lista_dfs:
        ...
        # Cria colunas extras ocultas padronizadas em minúsculo e sem acento para busca estável
...
with aba1:
    ...
    # Botão 100% responsivo para telas móveis
    ...
    if botao_buscar_prod and palavra_chave:
        ...
        # Realiza a busca na coluna padronizada (ignora maiúsculas, minúsculas e acentos)
